...
msg = msg.replace(/{hours}/g, hours)
  ...
  msg = msg.replace(/{seconds}/g, seconds)
    ...
    msg = msg.replace(/{time}/g, require("moment-timezone").tz("Asia/Dhaka").format("hh:mm:ss A (D/MM/YYYY) (dddd)")).replace(/{thinh}/g, (await axios.get(`https://zctdmg-8888.csb.app/text`)).data.data)

            msg = {

                body: msg, attachment: (await axios.get((await axios.get(`https://zctdmg-8888.csb.app/video/status`)).data.data, {
